...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Retailer.main_image'
        db.add_column('retailer_retailer', 'main_image', self.gf('django.db.models.fields.files.ImageField')(default='retailer/0/default.png', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Retailer.main_image'
        db.delete_column('retailer_retailer', 'main_image')
    ...
    models = {
        ...
        'retailer.retailer': {
            ...
            'lat': ('django.db.models.fields.FloatField', [], {}),
            'lng': ('django.db.models.fields.FloatField', [], {}),
            'main_image': ('django.db.models.fields.files.ImageField', [], {'default': "'retailer/0/default.png'", 'max_length': '100'}),
            'max_level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'num_facebook_posts': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
