...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Retailer.num_facebook_posts'
        db.add_column('retailer_retailer', 'num_facebook_posts', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Retailer.num_facebook_posts'
        db.delete_column('retailer_retailer', 'num_facebook_posts')
